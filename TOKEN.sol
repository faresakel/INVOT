...
/**
* @title AssetINVOT
* @dev Initial VOT supply creation
*/
contract AssetINVOT is ERC20Token {
    string public name = 'INVOT';
    uint8 public decimals = 18;
    string public symbol = 'VOT';
    string public version = '1';

    function AssetINVOT() public {
        totalSupply = 150000000 * (10**uint256(decimals)); //150 million initial token creation
        balances[msg.sender] = totalSupply; //all tokens for the contract creator
